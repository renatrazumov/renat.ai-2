      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center p-4 z-10">
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <GlitchText text="Create Account" className="text-2xl font-bold mb-2" />
            <p className="text-gray-400">Join renat.ai and explore the future of AI</p>
          </div>
          ...
          <p className="mt-6 text-center text-gray-400">
            ...
            <a href="/login" className="text-[#00FFB2] hover:text-[#00FFB2]/80 transition-colors">
              Sign in
            </a>
          </p>
        </div>
